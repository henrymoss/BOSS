...
class Legacy_Tests(unittest.TestCase):
	...
	def test_compare_grads_1(self):
		self.kern_new = StringKernel(implementation="numpy", alphabet=self.alphabet,order_coefs = [0.1, 0.2, 0.4, 0.5] ,
	...
	def test_compare_grads_2(self):
		self.kern_new = StringKernel(implementation="numpy", alphabet=self.alphabet,order_coefs = [0.1, 0.2, 0.4, 0.5, 0.7] ,
