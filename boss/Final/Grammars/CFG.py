...
class Grammar(CFG):
    ...
    def sampler_restricted(self, n, max_length=5,cfactor=0.1,min_length=0):
        ...
        # such that their parse tree depth at most d
        # and the number of production rule applications is at most p
    ...
    def sampler(self, n=1, convergent=True, cfactor=0.25):
