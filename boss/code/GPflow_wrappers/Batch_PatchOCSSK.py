...
class Batch_PatchOCSSK(Kernel):
   ...
   with hyperparameters:
    ...
    def kernel_calc(self,X_batch,X2_batch):
        ...
        if self.symmetric:
            k, dk_dgap, dk_dmatch,dk_dorder_coefs, dk_dkappa= self.kernel_calc_with_grads(X_batch,X2_batch)
        else:
    ...
    def kernel_calc_with_grads(self,X_batch,X2_batch):
        ...
        return k, dk_dgap, dk_dmatch, dk_dorder_coefs, dk_dkappa
